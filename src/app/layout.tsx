...
export const metadata: Metadata = {
  ...
  description: "Generate realistic Los Santos Police Department business cards — live preview, real badge images, high-quality PNG export and printable templates.",
  keywords: [
    "LSPD business card",
  ...
  authors: [{ name: "LSPD Card Generator", url: "https://example.com" }],
  openGraph: {
    title: "LSPD Card Generator",
    description: "Create realistic LSPD-style business cards with your own details and badge images.",
